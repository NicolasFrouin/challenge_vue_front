...
function addWidget(type: WidgetType, x: number, y: number, w: number, he: number) {
...
<template>
  <div>
    ...
    <!-- <div class="button-container">
      <button type="button" @click="saveDashboard" class="action-button save-button">Sauvegarder</button>
      <button type="button" @click="createWidget" class="action-button create-button">Ajouter un Widget</button>
    </div> -->
