...
<template>
  <div class="flex border-b-[1px] border-neutral-200 hover:shadow-lg min-w-[320px] max-w-[640px] p-4">
    <div class="relative overflow-hidden rounded-md w-[100px] sm:w-[176px]">
      <SfLink href="#">
        <img
          ...
          :src="
            product.image ??
            'https://storage.googleapis.com/sfui_docs_artifacts_bucket_public/production/smartwatch.png'
          "
    ...
    <div class="flex flex-col pl-4 min-w-[180px] flex-1">
      <SfLink href="#" variant="secondary" class="no-underline text-sm sm:text-lg">{{ product.name }}</SfLink>
      <!-- <div class="my-2 sm:mb-0">
        <ul class="font-normal leading-5 text-xs sm:text-sm text-neutral-700">
          <li>
      ...
      <div class="items-center sm:mt-auto sm:flex">
        ...
        <div class="flex items-center justify-between mt-4 sm:mt-0">
          ...
          <button
            aria-label="Remove"
            type="button"
            class="text-neutral-500 text-xs font-light ml-auto flex items-center px-3 py-1.5"
          >
            <SfIconDelete />
